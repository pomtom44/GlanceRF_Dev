...
- **Layout** — Any grid size, any monitor; modules resize to fit. Choose which modules go where and resize or expand cells. After the first setup save, an optional guided tour introduces the layout editor (skippable).
