...
| `layout_editor_tour_seen` | bool | false | When true, the post-setup layout editor intro tour is not shown for `?tour=1` (set by the app when you skip or complete the tour) |
...
- Default: `glancerf_config.json` in the project root
